      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex-shrink-0 flex items-center">
            <Link to="/worker/dashboard" className="flex items-center">
          ...
          <div className="hidden md:flex flex-1 justify-end gap-4 lg:gap-6 items-center min-w-0">
            <Link to="/worker/dashboard" className={linkClass('/worker/dashboard')}>{lang === 'hi' ? 'डैशबोर्ड' : 'Dashboard'}</Link>
            ...
            <div className="flex items-center space-x-4">
              <NotificationBell />
              <Link to="/worker/wallet" className="text-text-gray hover:text-primary font-medium flex items-center gap-1">
                <Wallet size={18} />
      ...
      {isOpen && (
        <div className="md:hidden bg-card-white border-t">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link to="/worker/dashboard" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-text-gray font-medium hover:bg-bg-warm rounded-md">Dashboard</Link>
            <Link to="/worker/wallet" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-text-gray font-medium hover:bg-bg-warm rounded-md">Earnings &amp; Payouts</Link>
